...
<aside id="sidebar" class="sidebar d-flex flex-column">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#">
        <i class="fa-solid fa-cloud"></i>
          <span class="font-serif text-xl">Weather Data Management</span>
      </a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link @if (Request::segment(1) != 'farmers') collapsed @endif" href="{{url('farmers/index')}}">
      <i class="fa-solid fa-camera-retro"></i>
        <span class="font-serif text-xl">Farmer Management</span>
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link collapsed" href="#">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#cooperative-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-menu-button-wide"></i><span class="font-serif text-xl">Cooperative Management</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="cooperative-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
      <li>
        <a class="nav-link @if (Request::segment(1) != 'cooperative') collapsed @endif" href="{{url('cooperatives')}}">
          <i class="bi bi-circle"></i><span class="font-serif text-xl">Cooperative Management</span>
        </a>
      </li>
      <li>
        <a class="nav-link @if (Request::segment(1) != 'assign') collapsed @endif" href="{{url('/assign')}}">
          <i class="bi bi-circle"></i><span class="font-serif text-xl">Assign Farmer to Cooperative</span>
        </a>
      </li>
    </ul>
  </li>
  ...
  <div class="ml-4">
    ...
    <a href="#">
      <span class="font-serif text-2xl ">Settings</span>
    </a>
  </div>
</aside><!-- End Sidebar -->
